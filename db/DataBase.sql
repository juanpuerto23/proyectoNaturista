...
CREATE SCHEMA usuario_cliente;

CREATE TABLE usuario_cliente.USER
(
	id_usuario INT NOT NULL,
    nombre VARCHAR NOT NULL,
    id_rol INT NOT NULL, -- Foreign Key from rol
    password VARCHAR NOT NULL,
	CONSTRAINT PK_USER PRIMARY KEY(id_usuario)
);

CREATE TABLE usuario_cliente.CLIENTE
(
	CEDULA int NOT NULL,
	NOMBRE varchar NOT NULL,
...
CREATE TABLE usuario_cliente.PROOVEDOR
(
...
CREATE TABLE usuario_cliente.VENDEDOR
(
...
CREATE TABLE facturacion.COMPRAS
(
	id_compra INT NOT NULL,
	cedula_cliente INT NOT NULL, -- Foreign Key from cliente
    id_producto INT NOT NULL, -- Foreign Key from producto
    id_vendedor INT NOT NULL, -- Foreing Key from proveedor
...
(
	...
	minimoStack INT NOT NULL,
	id_lote INT NOT NULL, -- Foreign Key from lote
...
(
	...
	id_proovedor INT NOT NULL, -- Foreign Key from proovedor
	coste_envio INT NOT NULL,
	CONSTRAINT PK_LOTE PRIMARY KEY(id_lote)
);

-- Relaciones

ALTER TABLE usuario_cliente.USER
ADD CONSTRAINT FK_USER_ROL
FOREIGN KEY (id_rol) REFERENCES Academico.ROL(id_rol);

ALTER TABLE usuario_cliente.CLIENTE
ADD CONSTRAINT FK_CLIENTE_PAIS
FOREIGN KEY (ID_PAIS) REFERENCES Academico.PAIS(ID);

ALTER TABLE usuario_cliente.CLIENTE
ADD CONSTRAINT FK_CLIENTE_DEPARTAMENTO
FOREIGN KEY (ID_DEPARTAMENTO) REFERENCES Academico.DEPARTAMENTO(ID);

ALTER TABLE usuario_cliente.CLIENTE
ADD CONSTRAINT FK_CLIENTE_CIUDAD
FOREIGN KEY (ID_CIUDAD) REFERENCES Academico.CIUDAD(ID);

ALTER TABLE usuario_cliente.CLIENTE
ADD CONSTRAINT FK_CLIENTE_TIPODOC
FOREIGN KEY (ID_TIPODOCUMENTO) REFERENCES Academico.TIPODOCUMENTO(ID);
...
ADD CONSTRAINT FK_LOTE_PROOVEDOR
FOREIGN KEY (id_proovedor) REFERENCES usuario_cliente.PROOVEDOR(id_proovedor);

ALTER TABLE facturacion.COMPRAS
ADD CONSTRAINT FK_COMPRAS_CLIENTE
FOREIGN KEY (cedula_cliente) REFERENCES usuario_cliente.CLIENTE(CEDULA);
...
ALTER TABLE facturacion.COMPRAS
ADD CONSTRAINT FK_COMPRAS_VENDEDOR
FOREIGN KEY (id_vendedor) REFERENCES usuario_cliente.VENDEDOR(id_vendedor);

ALTER TABLE Academico.DEPARTAMENTO
ADD CONSTRAINT FK_DEPARTAMENTO_PAIS
FOREIGN KEY (IDPAIS) REFERENCES Academico.PAIS(ID);

ALTER TABLE Academico.CIUDAD
ADD CONSTRAINT FK_CIUDAD_DEPARTAMENTO
FOREIGN KEY (IDDEPARTAMENTO) REFERENCES Academico.DEPARTAMENTO(ID);


-- Entrada de datos

INSERT INTO Academico.ROL(id_rol, nombre) VALUES 
(1, 'admin'),
(2, 'user');

INSERT INTO Academico.TIPODOCUMENTO(id, tipo) VALUES 
